 ...
 */
public class ThreadSafeBankAccount2_Solution4{
	private double balance = 0;
	private ReentrantLock lock;
	private Condition sufficientFundsCondition, belowUpperLimitFundsCondition;
	private ThreadSafeBankAccount2_Solution4 account;
	private double accountNumber;
	
	public ThreadSafeBankAccount2_Solution4(double accountNumber){
	...
	public static void main(String[] args){
		...
		ThreadSafeBankAccount2_Solution4 AccountA = new ThreadSafeBankAccount2_Solution4(1);
		ThreadSafeBankAccount2_Solution4 AccountB = new ThreadSafeBankAccount2_Solution4(2);
